// https://github.com/yanyiwu/husky/blob/master/deps/limonp/Logging.hpp

#ifndef BYTREE_LOGGING_HPP
#define BYTREE_LOGGING_HPP
...
#define LOG(level) bytree::Logger(bytree::level, __FILE__, __LINE__).Stream() 
